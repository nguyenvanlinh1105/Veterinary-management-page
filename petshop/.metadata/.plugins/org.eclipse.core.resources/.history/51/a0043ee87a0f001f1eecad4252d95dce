                    ...
                    <div class="col-md-4 order-md-2 mb-4">
                        ...
                        <ul class="list-group mb-3">
                            ...
                            <li class="list-group-item d-flex justify-content-between lh-condensed">
                                <div>
                                    <h6 class="my-0">Kiểm tra sức khỏe cơ bản</h6>
                                    <small class="text-muted">150000.0 x 2</small>
                                </div>
                                <span class="text-muted">300000.0</span>
                            </li>
                            ...
                            <li class="list-group-item d-flex justify-content-between lh-condensed">
                                <div>
                                    <h6 class="my-0">Tiêm phòng</h6>
                                    <small class="text-muted">200000.0 x 2</small>
                                </div>
                                <span class="text-muted">4000000.0</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between">
                                <span>Tổng thành tiền</span>
                                <strong>700000</strong>
                            </li>
                        </ul>
