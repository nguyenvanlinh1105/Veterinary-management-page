						...
						<div class="col-xs-12">
							...
							<div class="widget-box table-filter">
								<div class="table-btn-controls d-flex justify-content-between align-items-center pr-4">
                                    <h5 class="card-title mb-0">Danh sách chi tiết đơn hàng</h5>
                                    <div class="mb-2">
                                        <a flag="info" class="dt-button buttons-colvis btn btn-white btn-primary btn-bold " data-toggle="tooltip" title='Thêm chi tiêt đơn hàng' href='<c:url value="/admin-chiTietDonHang?type=edit"/>'>
                                            <span>
										...
										<table class="table table-bordered ">
											...
											<tbody>
												<c:forEach var="item" items="${model.listResult}">
													<tr>
														<td><input type="checkbox" id="check_${item.maDonHang}" value="${item.maDonHang}-${item.idDichVu}"></td>
														...
														<td>
															<c:url var="editURL" value="/admin-chiTietDonHang">
																<c:param name="type" value="edit"/>
																<c:param name="maDonHang" value="${item.maDonHang}"/>
