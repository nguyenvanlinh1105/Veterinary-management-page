...
<body>
	...
	<div class="main-content ml-2 pr-2">
		<form action="<c:url value='/admin-thuCung'/>" id="formSubmit" method="get">
					...
					<div class="col-xs-12">
						...
						<div class="widget-box table-filter">
							<div class="table-btn-controls d-flex justify-content-between align-items-center pr-4">
                                  <h5 class="card-title mb-0">Danh sách thú cưng</h5>
                                  <div class="mb-2">
                                      <a flag="info" class="dt-button buttons-colvis btn btn-white btn-primary btn-bold " data-toggle="tooltip" title='Thêm thú cưng' href='<c:url value="/admin-thuCung?type=edit"/>'>
                                          <span>
                                              <i class="fa fa-plus-circle bigger-110 purple"></i> Thêm thú cưng
                                          </span>
                                      </a>
										...
										<tbody>
											<c:forEach var="item" items="${model.listResult}">
												...
												<td><input type="checkbox" id="check_${item.idThuCung}" value="${item.idThuCung}"></td>
													...
													<td>
														<c:url var="editURL" value="/admin-thuCung">
