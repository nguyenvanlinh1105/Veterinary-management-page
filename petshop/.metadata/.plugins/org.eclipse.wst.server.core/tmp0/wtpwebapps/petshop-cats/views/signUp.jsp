...
<c:url var ="successURL" value="/trang-chu"/>
<c:url var ="lostURL" value="/dang-ki?action=signup"/>
			...
			<div class="card-body">
				...
				<form accept-charset="UTF-8" action="<c:url value='/dang-ki'/>" id="formSignUp" method="POST">
					...
					<div class="form-group">
						<input type="submit" id="btnUser" value="Đăng kí" class="btn float-right login_btn">
					</div>
...
function addNew(data) {
    $.ajax({
        ...
        error: function (error) {
        	console.log(error)
        	window.location.href = "${lostURL}?message=error_system";
        }
    });
}
