...
<body>
	...
	<div class="main-content ml-4 pr-4">
		<form action="<c:url value='/admin-nhanVien'/>" id="formSubmit" method="get">
						...
						<div class="col-xs-12">
							...
							<div class="widget-box table-filter">
								<div class="table-btn-controls d-flex justify-content-between align-items-center pr-4">
                                    ...
                                    <div class="mb-2">
                                        <a flag="info" class="dt-button buttons-colvis btn btn-white btn-primary btn-bold " data-toggle="tooltip" title='Thêm nhân viên' href='<c:url value="/admin-nhanVien?type=edit"/>'>
                                            <span>
                                                <i class="fa fa-plus-circle bigger-110 purple"></i> Thêm nhân viên
                                            </span>
                                        </a>
                                        <button id="btnDelete" type="button" class="dt-button buttons-html5 btn btn-white btn-primary btn-bold" data-toggle="tooltip" title='Xóa nhân viên'>
                                            <span>
													...
													<tr>
														...
														<td>
															...
															<a class="btn btn-sm btn-primary btn-edit" data-toggle="tooltip"
															   title="Cập nhật nhân viên" href='${editURL}'><i class="fa fa-edit" aria-hidden="true"></i>
															</a>
														</td>
