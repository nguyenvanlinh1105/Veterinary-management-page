<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <c:url var="APIurl" value="/api-admin-checkout"/>
<c:url var ="NewURL" value="/admin-paycart"/>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	<div class="container mt-4 mb-5 pb-5">
							 ...
							 <c:forEach var="item" items="${model.listResult}">
	                            <li class="list-group-item d-flex justify-content-between lh-condensed">
	                                ...
	                                <span class="text-muted">${item.thanhTien}</span>
	                                  <input type="hidden" id="maDonHang" name="madonHang" class="form-control" value="${item.maDonHang}">
	                            </li>
                             </c:forEach>
                    ...
                    <div class="col-md-7 order-md-1">
                        ...
                        <div class="d-block my-3">
                           <div class="custom-control custom-radio">
							    <input id="phThucThanhToan1" name="phThucThanhToan" type="radio" class="custom-control-input" value="Thanh toán trực tiếp">
							    <label class="custom-control-label" for="phThucThanhToan1">Thanh toán trực tiếp</label>
							</div>
							<div class="custom-control custom-radio">
							    <input id="phThucThanhToan2" name="phThucThanhToan" type="radio" class="custom-control-input" value="banking">
							    <label class="custom-control-label" for="phThucThanhToan2">banking</label>
							</div>

                        </div>
                        <hr class="mb-4">
                        <button class="btn btn-primary btn-lg btn-block" type="submit" id ="btnThanhToan"  value ="thanh toán" name="btnDatHang">Thanh toán</button>
                    </div>
                </div>
              	<input type="hidden" id="idUser" name="idUser" class="form-control" value="${khachHang.idUser}">
            </form>
        </div>
		...
		$('#btnThanhToan').click(function (e) {
		    ...
		    data['ids'] = ids;
		 // Chọn phần tử input có name là phThucThanhToan
