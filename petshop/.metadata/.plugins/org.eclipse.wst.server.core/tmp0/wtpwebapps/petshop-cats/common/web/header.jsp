			                ...
			                <div class="col-lg-6 ">
			                    <div class="d-flex align-items-center justify-content-end">
			                        ...
			                        <c:if test="${not empty USERMODEL}">                             
			                              <a class="nav-link text-white" href="#">Welcome 🥰! ${USERMODEL.tenuser}</a>                                                               
			                              <a class="nav-link text-white" href="<c:url value='/thoat?action=logout'/>">Thoát</a>    
			                              <a class="nav-link text-white " href="<c:url value='/web-cart'/>">
								            <i class="fa-solid fa-cart-shopping"></i>
								        	</a>  
									        <a class="nav-link text-white" href="<c:url value='/web-user?type=list'/>">
