            ...
            <div class="row">
				...
				<form id="formSubmit" class="row pr-5 pl-5">
				    ...
				    <div class="form-group col-sm-6">
				     ...
				     <div class="form-group col-sm-6">
				        <label class="control-label no-padding-right">Tên Admin</label>
				    ...
				    <div class="form-group col-sm-6">
				        <label class="control-label no-padding-right">Chức năng của admin</label>
				    ...
				    <div class="form-group col-sm-12">
				        <c:if test="${not empty model.idUser}">
				            <input type="button" class="btn btn-white btn-warning btn-bold" value="Cập nhật Admin" id="btnAddOrUpdateNew"/>
				        </c:if>
				        <c:if test="${empty model.idUser}">
				            <input type="button" class="btn btn-white btn-warning btn-bold" value="Thêm Admin" id="btnAddOrUpdateNew"/>
				        </c:if>
				    </div>
