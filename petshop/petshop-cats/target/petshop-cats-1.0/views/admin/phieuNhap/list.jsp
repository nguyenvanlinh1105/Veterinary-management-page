					...
					<div class="col-xs-12">
						...
						<div class="widget-box table-filter">
							<div class="table-btn-controls d-flex justify-content-between align-items-center pr-4">
                                  ...
                                  <div class="mb-2">
                                      <a flag="info" class="dt-button buttons-colvis btn btn-white btn-primary btn-bold " data-toggle="tooltip" title='Thêm thú cưng' href='<c:url value="/admin-phieuNhap?type=edit"/>'>
                                          <span>
		 ...
		 function deleteNew(data) {
	        $.ajax({
	            ...
	            success: function (result) {
	            	console.log(result);
	            	window.location.href = "${NewURL}?type=list&page=1&maxPageItem=8&sortName=maPN&sortBy=desc&message=delete_success";
	            },
