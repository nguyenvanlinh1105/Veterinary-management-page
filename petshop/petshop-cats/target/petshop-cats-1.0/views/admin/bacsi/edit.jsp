            ...
            <div class="row">
				...
				<form id="formSubmit" class="row pr-5 pl-5">
				    ...
				    <div class="form-group col-sm-6">
				     ...
				     <div class="form-group col-sm-6">
				        <label class="control-label no-padding-right">Tên Bác sĩ</label>
				    ...
				    <div class="form-group col-sm-6">
				        <label class="control-label no-padding-right">Chuyên ngành của bác sĩ</label>
				    ...
				    <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right">Thông tin Bác sĩ</label>
                                <div class="col-sm-9">                                 
				    ...
				    <div class="form-group col-sm-12">
				        <c:if test="${not empty model.idUser}">
				            <input type="button" class="btn btn-white btn-warning btn-bold" value="Cập nhật bác sĩ" id="btnAddOrUpdateNew"/>
				        </c:if>
				        <c:if test="${empty model.idUser}">
				            <input type="button" class="btn btn-white btn-warning btn-bold" value="Thêm bác sĩ" id="btnAddOrUpdateNew"/>
				        </c:if>
				    </div>
