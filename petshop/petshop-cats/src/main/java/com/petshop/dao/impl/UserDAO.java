...
public class UserDAO extends AbstractDAO<UserModel> implements IUserDAO{
	...
	@Override
	public void updateUserKhachHang(UserModel updateModel) {
		StringBuilder sql = new StringBuilder("UPDATE Users SET userName = ?, password = ?,");
		sql.append(" tenuser = ?, gioiTinh = ?,");
		sql.append(" ngaySinh=?, soDienThoai=?, email=?, ");
		sql.append(" modifieddate = ?, modifiedby = ? WHERE idUser = ?");
		update(sql.toString(), updateModel.getUserName(), updateModel.getPassword(), updateModel.getTenuser(),
				updateModel.getGioiTinh(),updateModel.getNgaySinh(),updateModel.getSoDienThoai()
		, updateModel.getEmail(),updateModel.getModifieddate(),updateModel.getModifiedby(), updateModel.getIdUser());
	}
