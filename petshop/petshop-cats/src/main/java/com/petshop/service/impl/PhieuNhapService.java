...
public class PhieuNhapService implements IPhieuNhapService {
	...
	@Override
	public PhieuNhapModel savePhieuNhap(PhieuNhapModel newModel) {
		newModel.setCreateddate(new Timestamp(System.currentTimeMillis()));
		Long newId= phieuNhapDAO.savePhieuNhap(newModel);
		return phieuNhapDAO.findOnePhieuNhap(newId);
	}

	@Override
	public PhieuNhapModel updatePhieuNhap(PhieuNhapModel updateModel) {
		updateModel.setModifieddate(new Timestamp(System.currentTimeMillis()));
		phieuNhapDAO.updatePhieuNhap(updateModel);
		return phieuNhapDAO.findOnePhieuNhap(updateModel.getMaPN());
	}

	@Override
	public void deletePhieuNhap(String[] ids) {
