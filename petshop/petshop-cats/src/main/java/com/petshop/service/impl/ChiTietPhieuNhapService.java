...
public class ChiTietPhieuNhapService  implements IChiTietPhieuNhapService{
	...
	public ChiTietPhieuNhapModel updateChiTietPhieuNhap(ChiTietPhieuNhapModel updatePN) {
		updatePN.setModifieddate(new Timestamp(System.currentTimeMillis()));
		chiTietPhieuNhapDAO.updateChiTietPhieuNhap(updatePN);
		return chiTietPhieuNhapDAO.findOneChiTietPhieuNhap(updatePN.getMaPN(),updatePN.getIdDichVu());
	}

	@Override
	public ChiTietPhieuNhapModel saveChiTietPhieuNhap(ChiTietPhieuNhapModel newModel) {
		newModel.setCreateddate(new Timestamp(System.currentTimeMillis()));
		Long newId= chiTietPhieuNhapDAO.saveChiTietPhieuNhap(newModel);
