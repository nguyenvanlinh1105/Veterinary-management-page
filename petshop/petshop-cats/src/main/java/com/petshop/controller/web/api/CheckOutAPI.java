...
public class CheckOutAPI extends HttpServlet{
	...
	protected void doPut(HttpServletRequest req, HttpServletResponse resp)
		...
		if(model!=null) {
			...
			donHangService.updateTrangThaiDonHangDichVu(donHang.getIds(),((UserModel) SessionUtil.getInstance().getValue(req, "USERMODEL")).getIdUser(),donHang.getPhThucThanhToan());
