	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		 ...
		 if(model!=null) {
			 String view="";
				...
				req.setAttribute("khachHang",userService.findOneKhachHang(req.getParameter("idUser")));
				dhmodel.setListResult(donHangCartService.findAllDichVuCartByIdUserChuaThanhToan(req.getParameter("idUser")));
