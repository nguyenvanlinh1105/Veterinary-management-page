...
@WebServlet(urlPatterns= {"/api-admin-the"})
public class TheAPI extends HttpServlet{
	@Inject 
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		TheModel newModel = HttpUtil.of(req.getReader()).toModel(TheModel.class);
		newModel.setCreatedby(((UserModel) SessionUtil.getInstance().getValue(req, "USERMODEL")).getTenuser());
		newModel = TheService.saveThe(newModel);
	...
	protected void doPut(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		updateThe = TheService.updateThe(updateThe);
	...
	protected void doDelete(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		TheService.deleteThe(newModel.getIds());
